...
<h1 class="wp-block-heading has-text-align-center has-white-color has-text-color has-link-color" style="font-size:32px"><?php echo esc_html__( 'News Left Sidebar', 'innovategrove' ); ?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
